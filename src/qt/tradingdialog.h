...
private slots:
    ...
    QString BuyCATO(QString OrderType, double Quantity, double Rate);
    QString SellCATO(QString OrderType, double Quantity, double Rate);
