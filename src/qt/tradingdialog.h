...
private slots:
    ...
    QString BuyPTN(QString OrderType, double Quantity, double Rate);
    QString SellPTN(QString OrderType, double Quantity, double Rate);
